  ...
  return (
    <div className="RegForm">
      ...
      <Form noValidate validated={validated} onSubmit={submitForm}>
        ...
        <Row className="mb-3">
        <Form.Group  as={Col} className="mb-3"  md="6" controlId="formDepartmentNmae" >
        ...
        <Form.Group className="mb-3" as={Col} md="6" controlId="formDepartmentNmae">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="6" className="mb-3" controlId="formMobileNo">
            <Form.Label>Contact No</Form.Label>

            <Form.Control type="Integer" required placeholder="Contact Number" name="mobileno" onChange={handleinputs} />
          </Form.Group>
          <Form.Group as={Col} className="mb-3" md="6" controlId="form=TelephoneNo">
        ...
        <Form.Group as={Col} className="mb-3" md="6" controlId="formEmail">
        ...
        <Row className="mb-3" >
          <Form.Group className="mb-3" as={Col} md="6" controlId="formdob">
          ...
          <Col>
            <Form.Group className="mb-3" as={Col} md="6" controlId="formBloodGroup">
